...
<div class="page-holder ng-scope" ng-view=""><div class="full-background ng-scope"></div>
  <div class="card login-card ng-scope" ng-controller="login_controller">
    <div class="login-logo">
      <!--?xml version="1.0" encoding="utf-8"?-->
      <!-- Generator: Adobe Illustrator 18.1.1, SVG Export Plug-In . SVG Version: 6.00 Build 0)  -->
      <svg version="1.1" id="enduro-logo" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 171.3 852 255" enable-background="new 0 171.3 852 255" xml:space="preserve">
		<g id="logo">
      <path id="polygon" fill="#231F20" d="M100.8,400.8l-73.2-42.3c-6.7-3.8-10.8-10.9-10.8-18.6v-84.6c0-7.7,4.1-14.8,10.8-18.6
				...
				C115.6,404.7,107.4,404.7,100.8,400.8z"></path>
      <path id="e" fill="#FFFFFF" d="M146.6,274.5c0,26.4-28.6,30.8-48.8,31c0.7,11.1,6.5,20.2,21.1,20.2c10.1,0,17.5-4.6,21.6-7.5
				l6.5,13.9c-2.7,2.4-14,9.6-30.2,9.6c-29.1,0-40.4-17.8-40.4-43.4c0-25.4,14.2-47.6,42.3-47.6C135.5,250.7,146.6,259.3,146.6,274.5z
				 M117.5,265.3c-13.7,0-19.9,13.2-20.4,25.9c12.7-0.2,30.7-3.1,30.7-16.3C127.8,268.6,123.7,265.3,117.5,265.3z"></path>
    </g>
        <g id="lettering">
          <path id="letter-e" fill="#010101" d="M315.6,342.3c-1,1.3-2.4,2.5-4.2,3.7c-1.8,1.2-3.9,2.3-6.2,3.2c-2.3,0.9-4.9,1.7-7.6,2.3
				...
				c-4.2,0-8,0.7-11.3,2c-3.3,1.3-6.2,3.2-8.6,5.7s-4.3,5.4-5.8,8.9c-1.5,3.5-2.4,7.3-2.9,11.5L313.9,307.3L313.9,307.3z"></path>
          <path id="letter-n" fill="#010101" d="M342.3,291.8c3.5-4.7,7.6-8.5,12.3-11.3c4.8-2.8,10-4.2,15.6-4.2c4.1,0,7.7,0.6,10.8,1.9
				...
				h-4v-74h1.9c0.9,0,1.4,0.5,1.5,1.5L342.3,291.8z"></path>
          <path id="letter-d" fill="#010101" d="M475.9,242.9v108.5h-1.8c-1,0-1.5-0.5-1.6-1.5l-0.4-13.2c-3.3,4.9-7.2,8.7-11.8,11.4
				...
				c0,11.8,2.2,20.5,6.6,26.1c4.4,5.7,10.9,8.5,19.4,8.5c5.2,0,10-1.4,14.4-4.3c4.4-2.8,8.3-6.8,11.6-11.8L472,292.4L472,292.4z"></path>
          <path id="letter-u" fill="#010101" d="M557.8,277.4v74H556c-0.9,0-1.4-0.5-1.6-1.5l-0.4-12.9c-3.5,4.7-7.6,8.5-12.4,11.4
				...
				c5.4,0,10.3-1.4,14.9-4.2c4.6-2.8,8.7-6.7,12.3-11.7v-56H557.8z"></path>
          <path id="letter-r" fill="#010101" d="M587.9,297.2c1.1-3.3,2.4-6.3,3.9-8.9c1.5-2.6,3.2-4.8,5.2-6.6c2-1.8,4.2-3.2,6.7-4.1
				...
				c-1.4,2.8-2.8,6.2-4,10v48.5h-4v-74h1.8c1,0,1.5,0.6,1.6,1.6L587.9,297.2z"></path>
          <path id="letter-o" fill="#010101" d="M659.8,276.2c5.2,0,9.9,0.9,14,2.7c4.1,1.8,7.5,4.4,10.3,7.7c2.8,3.3,4.9,7.3,6.4,12
				...
				s0.6,10,1.8,14.2c1.2,4.3,3,7.9,5.4,11s5.4,5.4,9,7.1C650.8,348.3,655,349.1,659.8,349.1z"></path>
          <path id="letter-dot" fill="#010101" d="M713.1,347c0-1.6,0.5-3,1.6-4.1c1.1-1.1,2.4-1.7,4-1.7c1.6,0,3,0.6,4.1,1.7
				c1.1,1.1,1.7,2.5,1.7,4.1c0,1.6-0.6,2.9-1.7,4c-1.1,1.1-2.5,1.6-4.1,1.6c-1.6,0-2.9-0.5-4-1.6C713.7,349.9,713.1,348.6,713.1,347z"></path>
          <path id="letter-j" fill="#010101" d="M754.2,277.4v85.5c0,2.3-0.4,4.5-1.1,6.5c-0.7,2-1.7,3.7-3.1,5.2c-1.4,1.4-3,2.6-5,3.4
				...
				C757.2,249.4,757.4,250,757.4,250.7z"></path>
          <path id="letter-s" fill="#010101" d="M820.8,285c-0.3,0.4-0.6,0.7-1.1,0.7c-0.4,0-1.1-0.3-1.9-1c-0.8-0.7-2-1.4-3.4-2.2
				...
				c2.1-1.8,4.5-3.2,7.4-4.2c2.9-1.1,6.1-1.6,9.6-1.6c4.3,0,8.1,0.6,11.4,1.8c3.3,1.2,6.4,3.1,9.4,5.7L820.8,285z"></path>
        </g>
		</svg>
    </div>
    <div class="card-body">
      ...
      <div>
        ...
        <div class="infobox" ng-class="{'hidden': !settings.login_message}">
          <i class="fa fa-exclamation-triangle"></i>
          <span class="ng-binding">Use username: demo, password: demo</span>
        </div>			<div class="wedge-2x"></div>
        <p class="hidden lost-password-assistance">Looks like you are having issues logging in. Please contact the site's administrator.</p>
      </div>

      <form ng-submit="submit()" class="ng-dirty ng-valid-parse ng-invalid ng-invalid-required">
        <div class="form-row">
          <label class="login-textfield-label">
            <input class="enduro_username ng-dirty ng-valid-parse ng-touched ng-empty ng-invalid ng-invalid-required" type="text" ng-model="enduro_username" required="" tabindex="1">
            <span>Username</span>
          </label>
        </div>
        <div class="form-row">
          <label class="login-textfield-label">
            <input class="enduro_password ng-dirty ng-valid-parse ng-touched ng-empty ng-invalid ng-invalid-required" type="password" ng-model="enduro_password" required="" tabindex="2">
            <span>Password</span>
          </label>
        </div>
        <div class="form-row">
          <div class="wedge-2x"></div>
          <button id="submit" type="submit" class="pull-right" tabindex="3">Submit</button>
        </div>
        <div class="clearfix"></div>
      </form>
      <div class="wedge-2x"></div>
      <div class="infobox hidden" ng-class="{'hidden': settings.has_admins}">
        <i class="fa fa-exclamation-triangle"></i>
        <span>Eh, there are no admin users. Add some by running <br><br><code>enduro admin add &lt;usr&gt; &lt;pass&gt;</code><br><br> in the console.</span>
      </div>
    </div>
  </div></div>